...
# Open the ROOT files
file1 = ROOT.TFile.Open(Rootfilesdirpath+"/1DHist_Sig_Displaced_300_290_full_1_1000.root")
...
hist_name_1 = variable+"_Sig_Displaced_300_290_full"
...
canvas.SaveAs(Rootfilesdirpath+"/"+variable+".png")
