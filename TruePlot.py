...
histos['PV_gVtx_dx'] = HistInfo(hname = 'PV_gVtx_dx', sample = sample, binning=[40,0,400], histclass = ROOT.TH1F).make_hist()
histos['PV_gVtx_dy'] = HistInfo(hname = 'PV_gVtx_dy', sample = sample, binning=[40,0,400], histclass = ROOT.TH1F).make_hist()
histos['PV_gVtx_dz'] = HistInfo(hname = 'PV_gVtx_dz', sample = sample, binning=[40,0,400], histclass = ROOT.TH1F).make_hist()
histos['PV_gLSP_dx'] = HistInfo(hname = 'PV_gLSP_dx', sample = sample, binning=[40,0,400], histclass = ROOT.TH1F).make_hist()
histos['PV_gLSP_dy'] = HistInfo(hname = 'PV_gLSP_dy', sample = sample, binning=[40,0,400], histclass = ROOT.TH1F).make_hist()
