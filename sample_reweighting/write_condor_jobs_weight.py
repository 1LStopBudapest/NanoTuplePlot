...
#2018 post processed nanoaod
input_folder="/eos/user/m/mleoncoe/stop_event_check/split_joint_samples_2018/"
input_folder_=input_folder.replace("root://eosuser.cern.ch/","")

output_folder = "/eos/user/m/mleoncoe/stop_event_check/stop_samples_weight_2018"
...
tmp_condor = open('jobs_2018/submitFile_stop_weight.condor', 'w')
...
print('condor_submit jobs_2018/submitFile_stop_weight.condor')