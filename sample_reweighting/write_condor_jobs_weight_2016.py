...
tmp_condor = open('jobs_2016/submitFile_stop_weight.condor', 'w')
tmp_condor.write('''Executable = execute_stop_weight.sh
Log        = jobs_2016/log_running_$(ProcId).log
Output     = jobs_2016/log_running_$(ProcId).out
Error      = jobs_2016/log_running_$(ProcId).error
...
print('condor_submit jobs_2016/submitFile_stop_weight.condor')