...
vList = ['cutFlow','nLeptonMeasured','truthMatchedLepton','nLeptonGen','2Dpt']
cutflow = ['nocut', 'lepton', 'xtralepton']
#cutflow = ['nocut', 'passFilters', 'met200', 'ht300', 'isr', 'tauveto', 'lepton', 'xtralepton', 'xtrajetveto', 'dphi', 'SR']
...
if 'T2tt' or 'Sig_Splitted' in samples:
    ...
    FillHistosBothBR(hfile, histos, ch03, ch10, options.year, options.nevents, sample, cutflow, branching_ratio, DataLumi, False).fill2()
    hfile.Write()
else:
