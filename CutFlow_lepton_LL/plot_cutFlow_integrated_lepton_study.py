...
custom_labels = ['nocut', 'lepton', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null', 'null']
...
canvas.SaveAs(out_plot_path + "/" + variable + "_cumulative_lep_study.png")