    ...
    def fill2(self):
        ...
        for ientry03 in range(n_entries03):
            ...
            if getsel03.gen4Body():
                ...
                ###TEST
                # print(" tree03.stopCtau = "+str(tree03.stopCtau))
                # print(" tree03.stopAntiCtau = "+str(tree03.stopAntiCtau))
                # print(" w_BRctau = "+str(w_BRctau))
                
                # print("ctau sample 0.3 = "+str(self.get_ctau_sample(0.3)))
                # print("ctau target 0.9 = "+str(self.get_ctau_sample(0.9)))
                # print(".............................")
                ############
        ...
        for key_ in self.histos:
            ...
            #self.histos[key_] = self.branching_ratio*histos10[key_] + (1-self.branching_ratio)*histos03[key_] + histos10_tail[key_]
        ...
        #his_10_tail.Scale(self.branching_ratio)
        his_10_tail.SetFillColor(ROOT.kRed - 7)          
        
        #
        # self.histos["stopCtauStack"].Add(self.histos["stopCtau"])
        self.histos["stopCtauStack"].Add(his_10)
        self.histos["stopCtauStack"].Add(his_03)
        self.histos["stopCtauStack"].Add(his_10_tail)
