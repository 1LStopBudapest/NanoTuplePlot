...
if is_combined == "combined":
    ...
    filepath = "/home/mleoncoe/stopAnalysis/test/Plots/1DFiles_LL/2016PostVFP/BR_"+BR_reweighted+"/1DHist_Sig_Splitted_"+str(mstop)+"_"+str(mX0)+"_0p300_1_1000.root"
    print(filepath)
    # Open the ROOT file
    file = ROOT.TFile.Open(filepath)
    hist = file.Get("stopCtau_Sig_Splitted_300_280_BR_0p300")
elif is_combined == "high":
    filepath = "/home/mleoncoe/stopAnalysis/test/Plots/1DFiles_LL/2016PostVFP/BR_"+BR_reweighted+"/1DHist_Sig_Splitted_"+str(mstop)+"_"+str(mX0)+"_1p000_1_1000.root"
    print(filepath)
    # Open the ROOT file
    file = ROOT.TFile.Open(filepath)
...
canvas.SaveAs("stop_ctau_"+BR_reweighted+"_masses_"+str(mstop)+"_"+str(mX0)+"_"+is_combined+".png")
