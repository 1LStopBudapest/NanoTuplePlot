...
mask_std_masspoint_combined = (stop_mass_combined % 5 == 0) & (x0_mass_combined % 5 == 0)
#mask_substraction = (stop_mass_combined - x0_mass_combined) > 11
mask_integral = integral_list > 10
ratio_combined_standard = ratio_combined[mask_integral & mask_std_masspoint_combined]
ratio_combined_non_standard = ratio_combined[mask_integral & ~mask_std_masspoint_combined]
...
#plt.hist(ratio_combined_non_standard, bins=bins, color=color2, edgecolor=edge_color, alpha=0.3, label="masspoint not multiples of 5")
plt.hist(ratio_combined_standard, bins=bins, color=color1, edgecolor=edge_color, alpha=0.3, label="masspoint multiples of 5")
