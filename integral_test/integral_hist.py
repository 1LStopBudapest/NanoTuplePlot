...
color6 = "brown"
edge_color = "black"
output_file = "ratio_histogram_all.png"
...
plt.hist(ratio_combined_standard, bins=bins, color=color1, edgecolor=edge_color, alpha=0.3, label="all masspoints")
