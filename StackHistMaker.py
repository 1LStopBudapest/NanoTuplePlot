...
if isinstance(samplelist[samples][0], types.ListType):
    ...
    for s in samplelist[samples]:
        ...
        histos['2ndJetPt'] = HistInfo(hname = '2ndJetPt', sample = histext, binning=[40,100,1000], histclass = ROOT.TH1F).make_hist()
        histos['2ndJetPt_100'] = HistInfo(hname = '2ndJetPt_100', sample = histext, binning=[40,100,1000], histclass = ROOT.TH1F).make_hist()
        histos['BjetPt'] = HistInfo(hname = 'BjetPt', sample = histext, binning=[40,100,1000], histclass = ROOT.TH1F).make_hist()
