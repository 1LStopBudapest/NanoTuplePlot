...
if isinstance(samplelist[samples][0], types.ListType):
    ...
    for s in samplelist[samples]:
        ...
        histos['ISRJetEta'] = HistInfo(hname = 'ISRJetEta', sample = histext, binning=[40,100,1000], histclass = ROOT.TH1F).make_hist()
        histos['SSRJetPt'] = HistInfo(hname = 'SSRJetPt', sample = histext, binning=[40,100,1000], histclass = ROOT.TH1F).make_hist()
        histos['Njet'] = HistInfo(hname = 'Njet', sample = histext, binning=[40,100,1000], histclass = ROOT.TH1F).make_hist()
        histos['BjetPt'] = HistInfo(hname = 'BjetPt', sample = histext, binning=[40,100,1000], histclass = ROOT.TH1F).make_hist()
        histos['Nbjet30'] = HistInfo(hname = 'Nbjet30', sample = histext, binning=[40,100,1000], histclass = ROOT.TH1F).make_hist()
