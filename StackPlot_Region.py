...
def get_parser():
    ...
    default=['VV', 'DYJetsToLL', 'ST', 'QCD', 'WJetsToLNu', 'TTbar', 'TTV', 'ZJetsToNuNu', 'T2tt_500_470', 'T2tt_800_720'], # last sample should be data as to be consistent with StackHists funtion.
    )
