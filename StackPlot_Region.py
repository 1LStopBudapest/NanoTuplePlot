...
def get_parser():
    ...
    default=['TTV', 'QCD', 'VV', 'DYJetsToLL', 'TTbar', 'ZJetsToNuNu', 'WJetsToLNu', 'ST', 'Sig_Displaced_300_290', 'Sig_Displaced_350_335', 'Sig_Displaced_400_380'],      # last sample should be data as to be consistent with StackHists funtion.
    )
