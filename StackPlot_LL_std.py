...
for sl in samplelists:
    if os.path.exists('StackHist_'+sl+'_std.root'):
        files.append(ROOT.TFile.Open('StackHist_'+sl+'_std.root'))
    #elif os.path.exists(plotDir+'StackFiles/Displaced/Dxy2/StackHist_'+sl+'.root'):
    #Moises
    elif os.path.exists(plotDir+'StackFiles/Displaced/Dxy2/total/StackHist_'+sl+'_std.root'):
        files.append(ROOT.TFile.Open(plotDir+'StackFiles/Displaced/Dxy2/total/StackHist_'+sl+'_std.root'))
    else:
        doplots = False        
...
if doplots :
    for v in vList:
        ...
        #Moises
        StackHistsExtNoData(files, samplelists, v, plotDir, 'Displaced/Dxy2_std', canvasX=800, canvasY=600)
        ########
