    ...
    def fill2(self):
        ...
        for ientry03 in range(n_entries03):
            ...
            if True:
                ...
                cuts = [
                    getsel03.passFilters,
                    getsel03.METcut,
                    getsel03.HTcut,
                    getsel03.ISRcut,
                    getsel03.tauVeto,
                    getsel03.lepcut,
                    getsel03.XtralepVeto,
                    getsel03.XtraJetVeto,
                    getsel03.dphicut,
                    getsel03.SearchRegion,
                ]
        ...
        for ientry10 in range(n_entries10):
            ...
            if True:
                ...
                cuts = [
                    getsel10.passFilters,
                    getsel10.METcut,
                    getsel10.HTcut,
                    getsel10.ISRcut,
                    getsel10.tauVeto,
                    getsel10.lepcut,
                    getsel10.XtralepVeto,
                    getsel10.XtraJetVeto,
                    getsel10.dphicut,
                    getsel10.SearchRegion,
                ]
